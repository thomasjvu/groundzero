        ...
        <Layout>
            <div id="container-post" className="flex flex-col gap-10">
                ...
                <section className="flex flex-col gap-5">
                    ...
                    <p className="font-mono">Boost your jobs from as little as $1.</p>
                    <div className="companies-grid grid grid-cols-3 grid-rows-2 gap-10">
                        <CardSlim title="Sticky" text="We'll pin your job to the top of our main page and every releveant search page" iconName="jam:pin-f"/>
